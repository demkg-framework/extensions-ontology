 ...
 * [demkg.yml](demkg.yml)
     * Determines how your purl.obolibrary.org/obo/demkg/ redirects will be handled
     ...
     * Paste in the contents of [demkg.yml](demkg.yml)
 ...
 * [demkg.md](demkg.md)
     ...
     * Paste in the contents of [demkg.md](demkg.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
