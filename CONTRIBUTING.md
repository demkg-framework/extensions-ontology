...
Please use our [Issue Tracker](https://github.com/DDI-NO/demkg/issues/) for reporting problems with the ontology. 
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/DDI-NO/demkg/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/DDI-NO/demkg/issues/new/choose).
